...
class ModelsTestCase(TestCase):
    ...
    def test_query_with_one_control(self):
        ...
        self.assertEqual(
            ...
            self.generate_expected(
                self.LOCAL_TEST_DATA_NAME if self.isolated_tests else self.LOCAL_TEST_DATA_NAME + self.FULL_TEST_DATA_NAME))
    ...
    def test_query_with_several_controls(self):
        ...
        self.assertEqual(
            executed,
            self.generate_expected(
                TEST_DATA_NAMES if self.isolated_tests else TEST_DATA_NAMES + self.FULL_TEST_DATA_NAME))
